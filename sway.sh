...
sudo pacman -S neofetch neovim neovide btop firefox thunderbird mpv imv bc libreoffice-fresh chromium bleachbit mixxx inkscape gimp evince ly rsync xdg-user-dirs wl-clipboard wf-recorder swaybg
